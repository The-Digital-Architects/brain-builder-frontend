"""
Django settings for middleware_code project.
...
ROOT_URLCONF = 'middleware_code.urls'
...
WSGI_APPLICATION = 'middleware_code.wsgi.application'

ASGI_APPLICATION = "middleware_code.asgi.application"
